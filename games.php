...
<p>At the end valid pairs would be counted and the winner will be declared.</p>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" name="crossword" onclick="window.location.href='password.html';">Play</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" name="tambola" onclick="window.location.href='password.html';">Play</button>
      </div>
    </div>
  </div>
</div>
...
<p>The scores will be as follows :</p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" name="spiz" onclick="window.location.href='password.html';">Play</button>
      </div>
    </div>
  </div>
</div>
...
<p>The scores will be as follows :</p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary"name="apti" onclick="window.location.href='password.html';">Play</button>
      </div>
    </div>
  </div>
</div>
...
<p>5. After structure falls ( -15 points to that player), if any player's turn is left in that round, they will be given a bonus question (15 points).</p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" name="jenga" onclick="window.location.href='password.html';">Play</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" name="3patti" onclick="window.location.href='password.html';">Play</button>
      </div>
    </div>
  </div>
</div>
...
<p>•	If you get red you lose your bet. </p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" name="unknown" onclick="window.location.href='password.html';">Play</button>
      </div>
    </div>
  </div>
</div>
